    ...
    return [
        {
            ...
            documentation: {
                ...
                value: [
                    ...
                    '\n',
                    '[Astro reference](https://docs.astro.build/en/writing/guides/typescript/#component-props)',
                ].join('\n'),
            },
            insertTextFormat: 2,
        ...
        },
        {
            ...
            documentation: {
                kind: 'markdown',
                value: [
                    'Add prerender export. When [using server-side rendering](https://docs.astro.build/en/writing/guides/on-demand-rendering/#enabling-on-demand-rendering), this value will be used to determine whether or not to prerender the page.',
                    '\n',

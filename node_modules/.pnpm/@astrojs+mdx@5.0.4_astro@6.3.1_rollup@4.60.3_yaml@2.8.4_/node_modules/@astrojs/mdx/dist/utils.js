...
function ignoreStringPlugins(plugins, logger) {
  ...
  if (hasInvalidPlugin) {
    logger.warn(
      `To inherit Markdown plugins in MDX, please use explicit imports in your config instead of "strings." See Markdown docs: https://docs.astro.build/en/writing/guides/markdown-content/#markdown-plugins`
    );
  }
  return validPlugins;
}

...
const CI_INSTRUCTIONS = {
	...
	GITHUB_ACTIONS:
		'https://docs.github.com/en/actions/writing/guides/building-and-testing-nodejs#specifying-the-nodejs-version',
...
Please upgrade Node.js to a supported version: "${engines}"\n`);
	...
	if (ci.isCI) {
		...
		console.log(`Documentation: https://docs.astro.build/en/writing/guides/deploy/`);

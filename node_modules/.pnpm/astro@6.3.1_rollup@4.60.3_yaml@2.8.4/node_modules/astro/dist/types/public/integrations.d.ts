...
interface AdapterExplicitProperties {
     ...
     * and only, behavior in a future major version. See [how to migrate](https://docs.astro.build/en/writing/guides/upgrade-to/v6/#deprecated-createexports-and-start-adapter-api).
     *

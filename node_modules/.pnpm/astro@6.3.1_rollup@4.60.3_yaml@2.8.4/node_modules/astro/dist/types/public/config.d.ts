...
export interface AstroUserConfig<TLocales extends Locales = never, TDriver extends SessionDriverName | SessionDriverConfig | undefined = never, TFontProviders extends Array<FontProvider> = never> {
     ...
     *   redirects: {
     *    '/old': '/new',
     *    '/blog/[...slug]': '/writing/articles/[...slug]',
     ...
     * @description
     *
     * Deploy to your favorite server, serverless, or edge host with build adapters. Import one of our first-party adapters ([Cloudflare](https://docs.astro.build/en/writing/guides/integrations-guide/cloudflare/), [Netlify](https://docs.astro.build/en/writing/guides/integrations-guide/netlify/), [Node.js](https://docs.astro.build/en/writing/guides/integrations-guide/node/), [Vercel](https://docs.astro.build/en/writing/guides/integrations-guide/vercel/)) or explore [community adapters](https://astro.build/integrations/2/?search=&categories%5B%5D=adapters) to enable on-demand rendering in your Astro project.
     *
     * See our [on-demand rendering guide](https://docs.astro.build/en/writing/guides/on-demand-rendering/) for more on Astro's server rendering options.
     *
     * ```js
     ...
     *
     * Read our [Integrations Guide](https://docs.astro.build/en/writing/guides/integrations/) for help getting started with Astro Integrations.
     *
     * ```js
    ...
    security?: {
         ...
         * - [Astro's view transitions](https://docs.astro.build/en/writing/guides/view-transitions/) using the `<ClientRouter />` are not supported, but you can [consider migrating to the browser native View Transition API](https://events-3bg.pages.dev/jotter/astro-view-transitions/) instead if you are not using Astro's enhancements to the native View Transitions and Navigation APIs.
         * - Shiki isn't currently supported. By design, Shiki functions use inline styles that cannot work with Astro CSP implementation. Consider [using `<Prism />`](https://docs.astro.build/en/writing/guides/syntax-highlighting/#prism-) when your project requires both CSP and syntax highlighting.
     ...
     * ```
     *
     * Session drivers are configured at build time. This means environment variables used in the driver configuration are inlined. You must create your own driver entrypoint to [override the configuration at runtime](https://docs.astro.build/en/writing/guides/sessions/#overriding-the-configuration-at-runtime).
     *
     * See [the sessions guide](https://docs.astro.build/en/writing/guides/sessions/) for more information.
     */
     ...
     * @description
     *
     * The driver to use for session storage. The [Node](https://docs.astro.build/en/writing/guides/integrations-guide/node/#sessions),
     * [Cloudflare](https://docs.astro.build/en/writing/guides/integrations-guide/cloudflare/#sessions), and
     * [Netlify](https://docs.astro.build/en/writing/guides/integrations-guide/netlify/#sessions) adapters automatically configure a default driver for you,
     ...
     *
     * See the [Prefetch guide](https://docs.astro.build/en/writing/guides/prefetch/) for more information.
     */
    prefetch?: boolean | {
        /**
         * @docs
    ...
    image?: {
         ...
         *
         * See [the images docs](https://docs.astro.build/en/writing/guides/images/#responsive-image-styles) for more information.
         */
    ...
    markdown?: {
         ...
         * ```
         *
         * See the [code syntax highlighting guide](https://docs.astro.build/en/writing/guides/syntax-highlighting/) for usage and examples.
         */
         ...
         * - `prism` - use the [Prism](https://prismjs.com/) highlighter and [provide your own Prism stylesheet](https://docs.astro.build/en/writing/guides/syntax-highlighting/#add-a-prism-stylesheet)
     ...
     *
     * See our guide for more information on [internationalization in Astro](https://docs.astro.build/en/writing/guides/internationalization/)
     */
    i18n?: {
        /**
         * @docs
         ...
         *
         * See the [Internationalization Guide](https://docs.astro.build/en/writing/guides/internationalization/#domains) for more details, including the limitations of this feature.
         */
     ...
     *
     * See our guide for more information on [environment variables in Astro](https://docs.astro.build/en/writing/guides/environment-variables/).
     */
    env?: {
        /**
         * @docs
     ...
     *
     * See our guide for more information on [using custom fonts in Astro](https://docs.astro.build/en/writing/guides/fonts/).
     */
    /**
     * @docs
     * @name font.provider
    ...
    experimental?: {
         ...
         *
         * See the [Prefetch Guide](https://docs.astro.build/en/writing/guides/prefetch/) for more `prefetch` options and usage.
         */
...
export interface AstroInlineOnlyConfig {
     ...
     * [environment variables documentation](https://docs.astro.build/en/writing/guides/environment-variables/) for more details.
     *

...
`
          ...
          if (await askToContinue({ flags, logger })) {
            ...
            logger.info(
              "SKIP_FORMAT",
              `
  @tailwindcss/vite requires additional configuration. Please refer to https://docs.astro.build/en/writing/guides/integrations-guide/tailwind/`
            );
          }
        } else {
...
Documentation: https://docs.astro.build/en/writing/guides/integrations/`;
  return err;
}
...
async function updateAstroConfig({
  ...
  ${bold(
          "https://docs.astro.build/en/writing/guides/deploy/"
        )}
`
      )
    );
...
async function updateTSConfig(cwd = process.cwd(), logger, integrationsInfo, flags, options) {
  ...
  More information: https://docs.astro.build/en/writing/guides/typescript/#errors-typing-multiple-jsx-frameworks-at-the-same-time
`
        )
      );
    }

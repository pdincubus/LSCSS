...
const StaticClientAddressNotAvailable = {
  ...
  hint: "See https://docs.astro.build/en/writing/guides/on-demand-rendering/ for more information on how to enable SSR."
};
...
const OnlyResponseCanBeReturned = {
  ...
  hint: "See https://docs.astro.build/en/writing/guides/on-demand-rendering/#response for more information."
};
...
See https://docs.astro.build/en/writing/guides/framework-components/ for more information on how to install and configure integrations.`
};
...
const GetStaticPathsRequired = {
  ...
  hint: `See https://docs.astro.build/en/writing/guides/routing/#dynamic-routes for more information on dynamic routes.
...
const NoAdapterInstalled = {
  ...
  hint: "See https://docs.astro.build/en/writing/guides/on-demand-rendering/ for more information."
};
...
const MissingImageDimension = {
  ...
  hint: "If your image is inside your `src` folder, you probably meant to import it instead. See [the Imports guide for more information](https://docs.astro.build/en/writing/guides/imports/#other-assets). You can also use `inferSize={true}` for remote images to get the original dimensions."
};
...
const LocalImageUsedWrongly = {
  ...
  hint: "If you want to use an image from your `src` folder, you need to either import it or if the image is coming from a content collection, use the [image() schema helper](https://docs.astro.build/en/writing/guides/images/#images-in-content-collections). See https://docs.astro.build/en/writing/guides/images/#src-required for more information on the `src` property."
};
...
const MissingSharp = {
  ...
  hint: "See Sharp's installation instructions for more information: https://sharp.pixelplumbing.com/install. If you are not relying on `astro:assets` to optimize, transform, or process any images, you can configure a passthrough image service instead of installing Sharp. See https://docs.astro.build/en/reference/errors/missing-sharp for more information.\n\nSee https://docs.astro.build/en/writing/guides/images/#default-image-service for more information on how to migrate to another image service."
};
...
const InvalidGlob = {
  ...
  hint: "See https://docs.astro.build/en/writing/guides/imports/#glob-patterns for more information on supported glob patterns."
};
...
const i18nNotEnabled = {
  ...
  hint: "See https://docs.astro.build/en/writing/guides/internationalization for a guide on setting up i18n."
};
...
const InvalidFrontmatterInjectionError = {
  ...
  hint: "See the frontmatter injection docs https://docs.astro.build/en/writing/guides/markdown-content/#modifying-frontmatter-programmatically for more information."
};
const MdxIntegrationMissingError = {
  ...
  hint: "See the MDX integration docs for installation and usage instructions: https://docs.astro.build/en/writing/guides/integrations-guide/mdx/"
};
...
const GetEntryDeprecationError = {
  ...
  hint: "See https://docs.astro.build/en/writing/guides/upgrade-to/v6/#removed-legacy-content-collections for more information."
};
const InvalidContentEntryFrontmatterError = {
  ...
  hint: "See https://docs.astro.build/en/writing/guides/content-collections/ for more information on content schemas."
};
...
const LegacyContentConfigError = {
  ...
  hint: "See https://docs.astro.build/en/writing/guides/upgrade-to/v6/#removed-legacy-content-collections for more information on updating collections."
};
const ContentCollectionMissingLoader = {
  ...
  hint: "See https://docs.astro.build/en/writing/guides/content-collections/ for more information on content loaders and https://docs.astro.build/en/writing/guides/upgrade-to/v6/#removed-legacy-content-collections for more information on migrating from legacy collections."
};
const ContentCollectionInvalidType = {
  ...
  hint: "See https://docs.astro.build/en/writing/guides/upgrade-to/v6/#removed-legacy-content-collections for more information on migrating from legacy collections."
};
const ContentLoaderReturnsInvalidId = {
  ...
  hint: "Make sure that the `id` of the entry is a string. See https://docs.astro.build/en/writing/guides/content-collections/ for more information on content loaders."
};
...
${extra}`;
  ...
  hint: "See https://docs.astro.build/en/writing/guides/content-collections/ for more information on content loaders."
};
const InvalidContentEntrySlugError = {
  ...
  hint: "See https://docs.astro.build/en/writing/guides/content-collections/ for more on the `slug` field."
};
...
const ActionsWithoutServerOutputError = {
  ...
  hint: "Add an adapter and enable on-demand rendering: https://docs.astro.build/en/writing/guides/on-demand-rendering/"
};
...
const SessionStorageInitError = {
  ...
  hint: "For more information, see https://docs.astro.build/en/writing/guides/sessions/"
};

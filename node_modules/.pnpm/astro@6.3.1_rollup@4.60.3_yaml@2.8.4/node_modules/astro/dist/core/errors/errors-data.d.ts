 ...
 * @docs
 * @see
 * - [Official integrations](https://docs.astro.build/en/writing/guides/integrations/#official-integrations)
 ...
 * @docs
 * @see
 * - [On-demand rendering](https://docs.astro.build/en/writing/guides/on-demand-rendering/)
 * - [Astro.clientAddress](https://docs.astro.build/en/reference/api-reference/#clientaddress)
 * @description
 ...
 * @docs
 * @see
 * - [Enabling SSR in Your Project](https://docs.astro.build/en/writing/guides/on-demand-rendering/)
 * - [Astro.clientAddress](https://docs.astro.build/en/reference/api-reference/#clientaddress)
 * @description
 * The `Astro.clientAddress` property is only available when [Server-side rendering](https://docs.astro.build/en/writing/guides/on-demand-rendering/) is enabled.
 *
 * To get the user's IP address in static mode, different APIs such as [Ipify](https://www.ipify.org/) can be used in a [Client-side script](https://docs.astro.build/en/writing/guides/client-side-scripts/) or it may be possible to get the user's IP using a serverless function hosted on your hosting provider.
 */
 ...
 * @description
 * A [dynamic route](https://docs.astro.build/en/writing/guides/routing/#dynamic-routes) was matched, but no corresponding path was found for the requested parameters. This is often caused by a typo in either the generated or the requested path.
 */
 ...
 * @see
 * - [Response](https://docs.astro.build/en/writing/guides/on-demand-rendering/#response)
 * @description
 ...
 * @see
 * - [Frameworks components](https://docs.astro.build/en/writing/guides/framework-components/)
 * - [UI Frameworks](https://docs.astro.build/en/writing/guides/integrations/#official-integrations)
 * @description
 * None of the installed integrations were able to render the component you imported. Make sure to install the appropriate integration for the type of component you are trying to include in your page.
 *
 * For JSX / TSX files, [@astrojs/react](https://docs.astro.build/en/writing/guides/integrations-guide/react/), [@astrojs/preact](https://docs.astro.build/en/writing/guides/integrations-guide/preact/) or [@astrojs/solid-js](https://docs.astro.build/en/writing/guides/integrations-guide/solid-js/) can be used. For Vue and Svelte files, the [@astrojs/vue](https://docs.astro.build/en/writing/guides/integrations-guide/vue/) and [@astrojs/svelte](https://docs.astro.build/en/writing/guides/integrations-guide/svelte/) integrations can be used respectively
 */
 ...
 * - [Hydrating framework components](https://docs.astro.build/en/writing/guides/framework-components/#hydrating-interactive-components)
 * @description
 ...
 * ```
 *
 * In routes using [rest parameters](https://docs.astro.build/en/writing/guides/routing/#rest-parameters), `undefined` can be used to represent a path with no parameters passed in the URL:
 *
 * ```astro title="/route/[...id].astro"
 * ---
 * export async function getStaticPaths() {
 ...
 * @docs
 * @see
 * - [Dynamic Routes](https://docs.astro.build/en/writing/guides/routing/#dynamic-routes)
 * - [`getStaticPaths()`](https://docs.astro.build/en/reference/routing-reference/#getstaticpaths)
 * - [Server-side Rendering](https://docs.astro.build/en/writing/guides/on-demand-rendering/)
 * @description
 * In [Static Mode](https://docs.astro.build/en/writing/guides/routing/#static-ssg-mode), all routes must be determined at build time. As such, dynamic routes must `export` a `getStaticPaths` function returning the different paths to generate.
 */
 ...
 * @docs
 * @see
 * - [Pagination](https://docs.astro.build/en/writing/guides/routing/#pagination)
 * @description
 ...
 * @docs
 * @see
 * - [Images](https://docs.astro.build/en/writing/guides/images/)
 ...
 *
 * If your image is inside your `src` folder, you probably meant to import it instead. See [the Imports guide for more information](https://docs.astro.build/en/writing/guides/imports/#other-assets).
 */
 ...
 * @docs
 * @see
 * - [Route Priority Order](https://docs.astro.build/en/writing/guides/routing/#route-priority-order)
 ...
 * @docs
 * @see
 * - [HTML streaming](https://docs.astro.build/en/writing/guides/on-demand-rendering/#html-streaming)
 * @description
 ...
 *
 * For local images from content collections, you can use the [image() schema helper](https://docs.astro.build/en/writing/guides/images/#images-in-content-collections) to resolve the images.
 *
 * ```astro
 * ---
 * import { Image } from "astro:assets";
 ...
 * @docs
 * @see
 * - [Configured redirects](https://docs.astro.build/en/writing/guides/routing/#configured-redirects)
 * @description
 ...
 * - [Dynamic routes](https://docs.astro.build/en/writing/guides/routing/#dynamic-routes)
 * @description
 * A dynamic route param is invalid. This is often caused by an `undefined` parameter or a missing [rest parameter](https://docs.astro.build/en/writing/guides/routing/#rest-parameters).
 */
 ...
 * @docs
 * @see
 * - [Default Image Service](https://docs.astro.build/en/writing/guides/images/#default-image-service)
 ...
 * @docs
 * @see
 * - [Type Imports](https://docs.astro.build/en/writing/guides/typescript/#type-imports)
 * @description
 ...
 *
 * This message can also appear when a type is imported without specifying that it is a [type import](https://docs.astro.build/en/writing/guides/typescript/#type-imports).
 */
 ...
 * @docs
 * @see
 * - [Glob Patterns](https://docs.astro.build/en/writing/guides/imports/#glob-patterns)
 * @description
 ...
 * @see
 * - [Internationalization](https://docs.astro.build/en/writing/guides/internationalization/#routing)
 ...
 *
 * @see
 * - [`i18n` routing](https://docs.astro.build/en/writing/guides/internationalization/#routing)
 */
 ...
 * ```
 *
 * For more information on internationalization support in Astro, see our [Internationalization guide](https://docs.astro.build/en/writing/guides/internationalization/).
 * @see
 * - [Internationalization](https://docs.astro.build/en/writing/guides/internationalization/)
 ...
 * @docs
 * @see
 * 	- [Styles and CSS](https://docs.astro.build/en/writing/guides/styling/)
 * @description
 ...
 * @docs
 * @see
 * - [Modifying frontmatter programmatically](https://docs.astro.build/en/writing/guides/markdown-content/#modifying-frontmatter-programmatically)
 * @description
 ...
 * @docs
 * @see
 * - [MDX installation and usage](https://docs.astro.build/en/writing/guides/integrations-guide/mdx/)
 * @description
 ...
 * @see
 * - [Content collections documentation](https://docs.astro.build/en/writing/guides/content-collections/)
 */
 ...
 * See the [Content collections documentation](https://docs.astro.build/en/writing/guides/content-collections/) for more information.
 ...
 * See the [Astro 6 migration guide](https://docs.astro.build/en/writing/guides/upgrade-to/v6/#removed-legacy-content-collections) for more information.
 */
 ...
 * @see
 * - [The reserved entry `slug` field](https://docs.astro.build/en/writing/guides/content-collections/)
 * @description
 ...
 * @docs
 * @see
 * - [Legacy content collections](https://docs.astro.build/en/writing/guides/upgrade-to/v5/#updating-existing-collections)
 * @description
 ...
 * @see
 * 	- [Sessions](https://docs.astro.build/en/writing/guides/sessions/)
 * @description
